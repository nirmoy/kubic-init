...
func newRegistryReconcilier(cfg *config.KubicInitConfiguration, mgr manager.Manager) reconcile.Reconciler {
...
func Add(mgr manager.Manager, kubicCfg *config.KubicInitConfiguration) error {
	return addRegController(kubicCfg, mgr, newRegistryReconcilier(kubicCfg, mgr))
}

// addRegController adds a new Controller to mgr with r as the reconcile.Reconciler
func addRegController(cfg *config.KubicInitConfiguration, mgr manager.Manager, r reconcile.Reconciler) error {
